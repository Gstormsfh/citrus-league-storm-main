...
- Use the league's actual scoring categories when available. Explain a material tradeoff: shots through a scoring drought, assists without many shots, peripherals with limited offence, or wins accompanied by ratio exposure. Without settings, make category recommendations conditional.
