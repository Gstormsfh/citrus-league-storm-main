...
// Static jersey number data scraped from NHL API (2025-26 rosters)
// This avoids runtime API calls — all jersey numbers are baked in at build time.
const JERSEY_NUMBERS: Record<string, number> = {
  // ANA - Anaheim Ducks
  'Leo Carlsson': 91, 'Sam Colangelo': 12, 'Cutter Gauthier': 61,
  'Mikael Granlund': 64, 'Jansen Harkins': 24, 'Ross Johnston': 44,
  'Alex Killorn': 17, 'Chris Kreider': 20, 'Mason McTavish': 23,
  'Nikita Nesterenko': 13, 'Ryan Poehling': 25, 'Beckett Sennecke': 45,
  'Ryan Strome': 16, 'Troy Terry': 19, 'Frank Vatrano': 77,
  'Jeffrey Viel': 28, 'Tim Washe': 42, 'Radko Gudas': 7,
  'Drew Helleson': 14, 'Jackson LaCombe': 2, 'Pavel Mintyukov': 98,
  'Ian Moore': 74, 'Jacob Trouba': 65, 'Olen Zellweger': 51,
  'Lukas Dostal': 1, 'Ville Husso': 33, 'Petr Mrazek': 34,
  // BOS - Boston Bruins
  'Viktor Arvidsson': 71, 'Michael Eyssimont': 81, 'Morgan Geekie': 39,
  'Tanner Jeannot': 84, 'Mark Kastelic': 47, 'Marat Khusnutdinov': 92,
  'Sean Kuraly': 52, 'Elias Lindholm': 28, 'Fraser Minten': 93,
  'Casey Mittelstadt': 11, 'David Pastrnak': 88, 'Alex Steeves': 21,
  'Pavel Zacha': 18, 'Jonathan Aspirot': 45, 'Jordan Harris': 43,
  'Henri Jokiharju': 20, 'Hampus Lindholm': 27, 'Mason Lohrei': 6,
  'Andrew Peeke': 26, 'Nikita Zadorov': 91, 'Joonas Korpisalo': 70,
  'Jeremy Swayman': 1,
  // BUF - Buffalo Sabres
  'Zach Benson': 6, 'Justin Danforth': 15, 'Josh Doan': 91,
  'Josh Dunne': 44, 'Jordan Greenway': 12, 'Tyson Kozak': 48,
  'Peyton Krebs': 19, 'Jiri Kulich': 20, 'Beck Malenstyn': 29,
  'Ryan McLeod': 71, 'Josh Norris': 9, 'Noah Ostlund': 86,
  'Jack Quinn': 22, 'Tage Thompson': 72, 'Alex Tuch': 89,
  'Jason Zucker': 17, 'Jacob Bryson': 78, 'Bowen Byram': 4,
  'Rasmus Dahlin': 26, 'Michael Kesselring': 8, 'Zach Metsa': 73,
  'Owen Power': 25, 'Mattias Samuelsson': 23, 'Conor Timmins': 21,
  'Colten Ellis': 92, 'Ukko-Pekka Luukkonen': 1, 'Alex Lyon': 34,
  // CGY - Calgary Flames
  'Mikael Backlund': 11, 'John Beecher': 18, 'Blake Coleman': 20,
  'Matt Coronato': 27, 'Joel Farabee': 86, 'Morgan Frost': 16,
  'Matvei Gridin': 92, 'Samuel Honzek': 29, 'Jonathan Huberdeau': 10,
  'Nazem Kadri': 91, 'Justin Kirkland': 23, 'Adam Klapka': 43,
  'Ryan Lomberg': 70, 'Martin Pospisil': 76, 'Yegor Sharangovich': 17,
  'Connor Zary': 47, 'Kevin Bahl': 7, 'Jake Bean': 24,
  'Hunter Brzustewicz': 48, 'Joel Hanley': 44, 'Yan Kuznetsov': 37,
  'Brayden Pachal': 94, 'Zayne Parekh': 19, 'MacKenzie Weegar': 52,
  'Zach Whitecloud': 28, 'Devin Cooley': 1, 'Dustin Wolf': 32,
  // CAR - Carolina Hurricanes
  'Sebastian Aho': 20, 'Jackson Blake': 53, 'William Carrier': 28,
  'Nikolaj Ehlers': 27, 'Taylor Hall': 71, 'Mark Jankowski': 77,
  'Seth Jarvis': 24, 'Jesperi Kotkaniemi': 82, 'Jordan Martinook': 48,
  'Eric Robinson': 50, 'Jordan Staal': 11, 'Logan Stankoven': 22,
  'Andrei Svechnikov': 37, 'Jalen Chatfield': 5, 'Shayne Gostisbehere': 4,
  "K'Andre Miller": 19, 'Alexander Nikishin': 21, 'Mike Reilly': 6,
  'Jaccob Slavin': 74, 'Sean Walker': 26, 'Frederik Andersen': 31,
  'Brandon Bussi': 32, 'Pyotr Kochetkov': 52,
  // CHI - Chicago Blackhawks
  'Connor Bedard': 98, 'Tyler Bertuzzi': 59, 'Andre Burakovsky': 28,
  'Colton Dach': 34, 'Jason Dickinson': 16, 'Ryan Donato': 8,
  'Nick Foligno': 17, 'Ryan Greene': 20, 'Sam Lafferty': 24,
  'Ilya Mikheyev': 95, 'Oliver Moore': 11, 'Frank Nazar': 91,
  'Landon Slaggert': 84, 'Teuvo Teravainen': 86, 'Louis Crevier': 46,
  'Matt Grzelcyk': 48, 'Wyatt Kaiser': 44, 'Kevin Korchinski': 14,
  'Artyom Levshunov': 55, 'Connor Murphy': 5, 'Sam Rinzel': 6,
  'Alex Vlasic': 72, 'Spencer Knight': 30, 'Arvid Soderblom': 40,
  // COL - Colorado Avalanche
  'Zakhar Bardakov': 93, 'Gavin Brindley': 54, 'Ross Colton': 20,
  'Jack Drury': 18, 'Parker Kelly': 17, 'Joel Kiviranta': 94,
  'Gabriel Landeskog': 92, 'Artturi Lehkonen': 62, 'Nathan MacKinnon': 29,
  'Martin Necas': 88, 'Brock Nelson': 11, 'Valeri Nichushkin': 13,
  'Victor Olofsson': 95, 'Brent Burns': 84, 'Samuel Girard': 49,
  'Cale Makar': 8, 'Sam Malinski': 70, 'Josh Manson': 42,
  'Devon Toews': 7, 'Mackenzie Blackwood': 39, 'Scott Wedgewood': 41,
  // CBJ - Columbus Blue Jackets
  'Charlie Coyle': 3, 'Adam Fantilli': 19, 'Danton Heinen': 43,
  'Boone Jenner': 38, 'Kent Johnson': 91, 'Isac Lundestrom': 21,
  'Kirill Marchenko': 86, 'Mason Marchment': 17, 'Sean Monahan': 23,
  'Mathieu Olivier': 24, 'Cole Sillinger': 4, 'Dmitri Voronkov': 10,
  'Miles Wood': 11, 'Jake Christiansen': 2, 'Dante Fabbro': 15,
  'Erik Gudbranson': 44, 'Denton Mateychuk': 5, 'Ivan Provorov': 9,
  'Damon Severson': 78, 'Brendan Smith': 7, 'Zach Werenski': 8,
  'Egor Zamula': 6, 'Jet Greaves': 73, 'Elvis Merzlikins': 90,
  // DAL - Dallas Stars
  'Nathan Bastian': 11, 'Jamie Benn': 14, 'Colin Blackwell': 15,
  'Mavrik Bourque': 22, 'Oskar Back': 10, 'Matt Duchene': 95,
  'Adam Erne': 73, 'Radek Faksa': 12, 'Roope Hintz': 24,
  'Justin Hryckowian': 49, 'Wyatt Johnston': 53, 'Mikko Rantanen': 96,
  'Jason Robertson': 21, 'Tyler Seguin': 91, 'Sam Steel': 18,
  'Lian Bichsel': 6, 'Kyle Capobianco': 20, 'Thomas Harley': 55,
  'Miro Heiskanen': 4, 'Esa Lindell': 23, 'Nils Lundkvist': 5,
  'Ilya Lyubushkin': 46, 'Alexander Petrovic': 28, 'Casey DeSmith': 1,
  'Jake Oettinger': 29,
  // DET - Detroit Red Wings
  'Mason Appleton': 22, 'J.T. Compher': 37, 'Andrew Copp': 18,
  'Alex DeBrincat': 93, 'Emmitt Finnie': 58, 'Patrick Kane': 88,
  'Marco Kasper': 92, 'Dylan Larkin': 71, 'Michael Rasmussen': 27,
  'Lucas Raymond': 23, 'Elmer Soderblom': 85, 'James van Riemsdyk': 21,
  'Jacob Bernard-Docker': 25, 'Ben Chiarot': 8, 'Simon Edvinsson': 77,
  'Erik Gustafsson': 56, 'Travis Hamonic': 52, 'Albert Johansson': 20,
  'Axel Sandin-Pellikka': 44, 'Moritz Seider': 53, 'John Gibson': 36,
  'Cam Talbot': 39,
  // EDM - Edmonton Oilers
  'Leon Draisaitl': 29, 'Trent Frederic': 10, 'Adam Henrique': 19,
  'Zach Hyman': 18, 'Mattias Janmark': 13, 'Kasperi Kapanen': 42,
  'Curtis Lazar': 20, 'Andrew Mangiapane': 88, 'Connor McDavid': 97,
  'Ryan Nugent-Hopkins': 93, 'Vasily Podkolzin': 92, 'Jack Roslovic': 28,
  'Evan Bouchard': 2, 'Mattias Ekholm': 14, 'Ty Emberson': 49,
  'Darnell Nurse': 25, 'Alec Regula': 75, 'Spencer Stastney': 24,
  'Jake Walman': 96, 'Connor Ingram': 39, 'Tristan Jarry': 35,
  // FLA - Florida Panthers
  'Aleksander Barkov': 16, 'Sam Bennett': 9, 'Jesper Boqvist': 70,
  'Jonah Gadjovich': 12, 'A.J. Greer': 10, 'Luke Kunin': 71,
  'Anton Lundell': 15, 'Eetu Luostarinen': 27, 'Brad Marchand': 63,
  'Sam Reinhart': 13, 'Evan Rodrigues': 17, 'Mackie Samoskevich': 11,
  'Cole Schwindt': 79, 'Matthew Tkachuk': 19, 'Carter Verhaeghe': 23,
  'Sandis Vilmanis': 95, 'Uvis Balinskis': 26, 'Tobias Bjornfot': 22,
  'Aaron Ekblad': 5, 'Gustav Forsling': 42, 'Seth Jones': 3,
  'Dmitry Kulikov': 7, 'Niko Mikkola': 77, 'Jeff Petry': 2,
  'Donovan Sebrango': 6, 'Sergei Bobrovsky': 72, 'Daniil Tarasov': 40,
  // LAK - Los Angeles Kings
  'Joel Armia': 40, 'Quinton Byfield': 55, 'Kevin Fiala': 22,
  'Warren Foegele': 37, 'Samuel Helenius': 79, 'Adrian Kempe': 9,
  'Anze Kopitar': 11, 'Andrei Kuzmenko': 96, 'Alex Laferriere': 14,
  'Andre Lee': 47, 'Jeff Malott': 39, 'Trevor Moore': 12,
  'Artemi Panarin': 72, 'Corey Perry': 10, 'Alex Turcotte': 15,
  'Taylor Ward': 52, 'Mikey Anderson': 44, 'Cody Ceci': 5,
  'Brandt Clarke': 92, 'Drew Doughty': 8, 'Brian Dumoulin': 2,
  'Joel Edmundson': 6, 'Jacob Moverare': 43, 'Anton Forsberg': 31,
  'Darcy Kuemper': 35,
  // MIN - Minnesota Wild
  'Matt Boldy': 12, 'Joel Eriksson Ek': 14, 'Marcus Foligno': 17,
  'Ryan Hartman': 38, 'Vinnie Hinostroza': 18, 'Marcus Johansson': 90,
  'Kirill Kaprizov': 97, 'Boris Katchouk': 61, 'Nico Sturm': 78,
  'Vladimir Tarasenko': 91, 'Yakov Trenin': 13, 'Danila Yurov': 22,
  'Mats Zuccarello': 36, 'Zach Bogosian': 24, 'Jonas Brodin': 25,
  'Brock Faber': 7, 'Ben Gleason': 41, 'Quinn Hughes': 43,
  'Daemon Hunt': 48, 'Jake Middleton': 5, 'David Spacek': 82,
  'Jared Spurgeon': 46, 'Filip Gustavsson': 32, 'Jesper Wallstedt': 30,
  // MTL - Montreal Canadiens
  'Josh Anderson': 17, 'Zachary Bolduc': 76, 'Cole Caufield': 13,
  'Kirby Dach': 77, 'Phillip Danault': 24, 'Ivan Demidov': 93,
  'Jake Evans': 71, 'Brendan Gallagher': 11, 'Oliver Kapanen': 91,
  'Patrik Laine': 92, 'Alex Newhook': 15, 'Juraj Slafkovsky': 20,
  'Nick Suzuki': 14, 'Alexandre Texier': 85, 'Joe Veleno': 90,
  'Alexandre Carrier': 45, 'Noah Dobson': 53, 'Kaiden Guhle': 21,
  'Lane Hutson': 48, 'Mike Matheson': 8, 'Jayden Struble': 47,
  'Arber Xhekaj': 72, 'Jakub Dobes': 75, 'Samuel Montembeault': 35,
  // NSH - Nashville Predators
  'Michael Bunting': 58, 'Luke Evangelista': 77, 'Filip Forsberg': 9,
  'Erik Haula': 56, 'Tyson Jost': 17, 'Jonathan Marchessault': 81,
  'Michael McCarron': 47, "Ryan O'Reilly": 90, 'Cole Smith': 36,
  'Steven Stamkos': 91, 'Ozzy Wiesblatt': 89, 'Justin Barron': 20,
  'Nick Blankenburg': 37, 'Nicolas Hague': 41, 'Roman Josi': 59,
  'Nick Perbix': 48, 'Brady Skjei': 76, 'Adam Wilsby': 83,
  'Justus Annunen': 29, 'Matt Murray': 32, 'Juuse Saros': 74,
  // NJD - New Jersey Devils
  'Nick Bjugstad': 72, 'Jesper Bratt': 63, 'Connor Brown': 16,
  'Paul Cotter': 47, 'Evgenii Dadonov': 33, 'Cody Glass': 12,
  'Luke Glendening': 14, 'Arseni Gritsyuk': 81, 'Lenni Hameenaho': 29,
  'Nico Hischier': 13, 'Zack MacEwen': 15, 'Timo Meier': 28,
  'Dawson Mercer': 91, 'Stefan Noesen': 11, 'Maxim Tsyplakov': 42,
  'Dylan Wendt': 59, 'Dennis Cholowski': 44, 'Brenden Dillon': 5,
  'Dougie Hamilton': 7, 'Luke Hughes': 43, 'Johnathan Kovacevic': 8,
  'Brett Pesce': 22, 'Jonas Siegenthaler': 71, 'Colton White': 45,
  'Jake Allen': 34, 'Jacob Markstrom': 25,
  // NYI - New York Islanders
  'Mathew Barzal': 13, 'Casey Cizikas': 53, 'Jonathan Drouin': 29,
  'Anthony Duclair': 11, 'Marc Gatcomb': 16, 'Emil Heineman': 51,
  'Simon Holmstrom': 10, 'Bo Horvat': 14, 'Anders Lee': 27,
  'Kyle MacLean': 32, 'Jean-Gabriel Pageau': 44, 'Ondrej Palat': 81,
  'Kyle Palmieri': 21, 'Calum Ritchie': 64, 'Adam Boqvist': 34,
  'Tony DeAngelo': 77, 'Scott Mayfield': 24, 'Adam Pelech': 3,
  'Ryan Pulock': 6, 'Alexander Romanov': 28, 'Matthew Schaefer': 48,
  'Carson Soucy': 4, 'David Rittich': 33, 'Ilya Sorokin': 30,
  'Semyon Varlamov': 40,
  // NYR - New York Rangers
  'Brendan Brisson': 91, 'Jonny Brodzinski': 22, 'Sam Carrick': 39,
  'Will Cuylle': 50, 'Adam Edstrom': 84, 'Noah Laba': 42,
  'Alexis Lafreniere': 13, 'J.T. Miller': 8, 'Brennan Othmann': 78,
  'Gabe Perreault': 94, 'Taylor Raddysh': 14, 'Matt Rempe': 73,
  'Conor Sheary': 43, 'Vincent Trocheck': 16, 'Mika Zibanejad': 93,
  'Will Borgen': 17, 'Adam Fox': 23, 'Vladislav Gavrikov': 44,
  'Vincent Iorio': 6, 'Scott Morrow': 60, 'Matthew Robertson': 29,
  'Braden Schneider': 4, 'Urho Vaakanainen': 18, 'Hugo Ollas': 80,
  'Jonathan Quick': 32, 'Igor Shesterkin': 31,
  // OTT - Ottawa Senators
  'Michael Amadio': 22, 'Drake Batherson': 19, 'Nick Cousins': 21,
  'Dylan Cozens': 24, 'Lars Eller': 89, 'Claude Giroux': 28,
  'Ridly Greig': 71, 'Kurtis MacDermid': 23, 'David Perron': 57,
  'Shane Pinto': 12, 'Tim Stutzle': 18, 'Brady Tkachuk': 7,
  'Fabian Zetterlund': 20, 'Thomas Chabot': 72, 'Nick Jensen': 3,
  'Tyler Kleven': 43, 'Nikolas Matinpalo': 33, 'Jake Sanderson': 85,
  'Jordan Spence': 10, 'Artem Zub': 2, 'James Reimer': 47,
  'Linus Ullmark': 35,
  // PHI - Philadelphia Flyers
  'Rodrigo Abols': 18, 'Denver Barkey': 52, 'Bobby Brink': 10,
  'Noah Cates': 27, 'Sean Couturier': 14, 'Nicolas Deslauriers': 44,
  'Christian Dvorak': 22, 'Tyson Foerster': 71, 'Nikita Grebenkin': 29,
  'Carl Grundstrom': 91, 'Garnet Hathaway': 19, 'Travis Konecny': 11,
  'Matvei Michkov': 39, 'Owen Tippett': 74, 'Trevor Zegras': 46,
  'Emil Andrae': 36, 'Jamie Drysdale': 9, 'Adam Ginning': 13,
  'Noah Juulsen': 47, 'Nick Seeler': 24, 'Cam York': 8,
  'Samuel Ersson': 33, 'Dan Vladar': 80,
  // PIT - Pittsburgh Penguins
  'Noel Acciari': 55, 'Justin Brazeau': 16, 'Egor Chinakhov': 59,
  'Sidney Crosby': 87, 'Connor Dewar': 19, 'Filip Hallander': 11,
  'Kevin Hayes': 13, 'Benjamin Kindel': 81, 'Blake Lizotte': 46,
  'Evgeni Malkin': 71, 'Anthony Mantha': 39, 'Tommy Novak': 18,
  'Rickard Rakell': 67, 'Bryan Rust': 17, 'Connor Clifton': 75,
  'Ryan Graves': 27, 'Erik Karlsson': 65, 'Brett Kulak': 77,
  'Kris Letang': 58, 'Ryan Shea': 5, 'Ilya Solovyov': 7,
  'Jack St. Ivany': 3, 'Parker Wotherspoon': 28, 'Arturs Silovs': 37,
  'Stuart Skinner': 74,
  // SEA - Seattle Kraken
  'Matty Beniers': 10, 'Berkly Catton': 27, 'Jordan Eberle': 7,
  'Frederick Gaudreau': 89, 'Kaapo Kakko': 84, 'Tye Kartye': 12,
  'Jared McCann': 19, 'Jacob Melanson': 63, 'Ben Meyers': 59,
  'Jaden Schwartz': 17, 'Chandler Stephenson': 9, 'Eeli Tolvanen': 20,
  'Ryan Winterton': 26, 'Shane Wright': 51, 'Vince Dunn': 29,
  'Ryker Evans': 41, 'Cale Fleury': 8, 'Adam Larsson': 6,
  'Ryan Lindgren': 55, 'Joshua Mahura': 28, 'Brandon Montour': 62,
  'Jamie Oleksiak': 24, 'Joey Daccord': 35, 'Philipp Grubauer': 31,
  // SJS - San Jose Sharks
  'Filip Bystedt': 18, 'Ty Dellandrea': 10, 'William Eklund': 72,
  'Adam Gaudette': 81, 'Barclay Goodrow': 23, 'Collin Graf': 51,
  'Philipp Kurashev': 96, 'Michael Misa': 77, 'Zack Ostapchuk': 63,
  'Ryan Reaves': 75, 'Pavol Regenda': 84, 'Kiefer Sherwood': 44,
  'Will Smith': 2, 'Tyler Toffoli': 73, 'Alexander Wennberg': 21,
  'Vincent Desharnais': 5, 'Sam Dickinson': 6, 'Mario Ferraro': 38,
  'John Klingberg': 3, 'Nick Leddy': 4, 'Timothy Liljegren': 37,
  'Shakir Mukhamadullin': 85, 'Dmitry Orlov': 9, 'Yaroslav Askarov': 30,
  'Alex Nedeljkovic': 33,
  // STL - St. Louis Blues
  'Jonatan Berggren': 29, 'Pavel Buchnevich': 89, 'Dalibor Dvorsky': 54,
  'Robby Fabbri': 9, 'Jack Finley': 37, 'Dylan Holloway': 81,
  'Mathieu Joseph': 71, 'Jordan Kyrou': 25, 'Jake Neighbours': 63,
  'Brayden Schenn': 10, 'Jimmy Snuggerud': 21, 'Oskar Sundqvist': 70,
  'Pius Suter': 22, 'Robert Thomas': 18, 'Alexey Toropchenko': 13,
  'Nathan Walker': 26, 'Philip Broberg': 6, 'Justin Faulk': 72,
  'Cam Fowler': 17, 'Matthew Kessel': 51, 'Logan Mailloux': 23,
  'Colton Parayko': 55, 'Tyler Tucker': 75, 'Jordan Binnington': 50,
  'Joel Hofer': 30,
  // TBL - Tampa Bay Lightning
  'Oliver Bjorkstrand': 22, 'Anthony Cirelli': 71, 'Curtis Douglas': 42,
  'Zemgus Girgensons': 28, 'Gage Goncalves': 93, 'Yanni Gourde': 37,
  'Jake Guentzel': 59, 'Brandon Hagel': 38, 'Pontus Holmberg': 29,
  'Dominic James': 17, 'Nikita Kucherov': 86, 'Nick Paul': 20,
  'Brayden Point': 21, 'Scott Sabourin': 46, 'Declan Carlile': 67,
  'Erik Cernak': 81, 'Maxwell Crozier': 24, "Charle-Edouard D'Astous": 51,
  'Victor Hedman': 77, 'Emil Lilleberg': 78, 'Ryan McDonagh': 27,
  'J.J. Moser': 90, 'Darren Raddysh': 43, 'Jonas Johansson': 31,
  'Andrei Vasilevskiy': 88,
  // TOR - Toronto Maple Leafs
  'Easton Cowan': 53, 'Max Domi': 11, 'Calle Jarnkrok': 19,
  'Dakota Joshua': 81, 'Matthew Knies': 23, 'Scott Laughton': 24,
  'Steven Lorentz': 18, 'Matias Maccelli': 63, 'Auston Matthews': 34,
  'Bobby McMann': 74, 'William Nylander': 88, 'Nicholas Robertson': 89,
  'Nicolas Roy': 55, 'John Tavares': 91, 'Simon Benoit': 2,
  'Brandon Carlo': 25, 'Oliver Ekman-Larsson': 95, 'Jake McCabe': 22,
  'Philippe Myers': 51, 'Morgan Rielly': 44, 'Troy Stecher': 28,
  'Chris Tanev': 8, 'Anthony Stolarz': 41, 'Joseph Woll': 60,
  // UTA - Utah Hockey Club
  'Michael Carcone': 53, 'Logan Cooley': 92, 'Lawson Crouse': 67,
  'Dylan Guenther': 11, 'Barrett Hayton': 27, 'Alexander Kerfoot': 15,
  'Jack McBain': 22, 'Ben McCartney': 62, "Liam O'Brien": 38,
  'JJ Peterka': 77, 'Nick Schmaltz': 8, 'Kevin Stenlund': 82,
  'Brandon Tanev': 13, 'Kailer Yamamoto': 56, 'Ian Cole': 28,
  'Kevin Connauton': 44, 'Nick DeSimone': 57, 'Sean Durzi': 50,
  'John Marino': 6, 'Scott Perunovich': 48, 'Nate Schmidt': 88,
  'Mikhail Sergachev': 98, 'Vitek Vanecek': 41, 'Karel Vejmelka': 70,
  // VAN - Vancouver Canucks
  'Nils Aman': 88, 'Teddy Blueger': 53, 'Brock Boeser': 6,
  'Filip Chytil': 72, 'Jake DeBrusk': 74, 'Conor Garland': 8,
  'Nils Hoglander': 21, 'David Kampf': 64, 'Evander Kane': 91,
  'Linus Karlsson': 94, "Drew O'Connor": 18, 'Liam Ohgren': 92,
  'Elias Pettersson': 40, 'Aatu Raty': 54, 'Marco Rossi': 93,
  'Max Sasson': 63, 'Zeev Buium': 24, 'Derek Forbort': 27,
  'Filip Hronek': 17, 'Pierre-Olivier Joseph': 7, 'Tyler Myers': 57,
  'Marcus Pettersson': 29, 'Tom Willander': 5, 'Thatcher Demko': 35,
  'Kevin Lankinen': 32, 'Jiri Patera': 30,
  // VGK - Vegas Golden Knights
  'Ivan Barbashev': 49, 'Braeden Bowman': 42, 'Pavel Dorofeyev': 16,
  'Jack Eichel': 9, 'Tomas Hertl': 48, 'Alexander Holtz': 26,
  'Brett Howden': 21, 'William Karlsson': 71, 'Keegan Kolesar': 55,
  'Mitch Marner': 93, 'Cole Reinhardt': 23, 'Jonas Rondbjerg': 46,
  'Brandon Saad': 20, 'Colton Sissons': 10, 'Reilly Smith': 19,
  'Mark Stone': 61, 'Rasmus Andersson': 4, 'Noah Hanifin': 15,
  'Ben Hutton': 17, 'Kaedan Korczak': 6, 'Jeremy Lauzon': 5,
  'Brayden McNabb': 3, 'Shea Theodore': 27, 'Carter Hart': 79,
  'Adin Hill': 33, 'Akira Schmid': 40,
  // WPG - Winnipeg Jets
  'Morgan Barron': 36, 'Kyle Connor': 81, 'Walker Duehr': 71,
  'Alex Iafallo': 9, 'Cole Koepke': 45, 'Adam Lowry': 17,
  'Vladislav Namestnikov': 7, 'Nino Niederreiter': 62, 'Gustav Nyquist': 14,
  'Tanner Pearson': 70, 'Cole Perfetti': 91, 'Mark Scheifele': 55,
  'Jonathan Toews': 19, 'Gabriel Vilardi': 13, 'Dylan DeMelo': 2,
  'Haydn Fleury': 24, 'Ville Heinola': 34, 'Colin Miller': 6,
  'Neal Pionk': 4, 'Elias Salomonsson': 57, 'Dylan Samberg': 54,
  'Luke Schenn': 5, 'Logan Stanley': 64, 'Eric Comrie': 1,
  'Connor Hellebuyck': 37,
  // WSH - Washington Capitals
  'Anthony Beauvillier': 72, 'Nic Dowd': 26, 'Pierre-Luc Dubois': 80,
  'Brandon Duhaime': 22, 'Ethen Frank': 53, 'Hendrix Lapierre': 29,
  'Ryan Leonard': 9, 'Connor McMichael': 24, 'Sonny Milano': 15,
  'Alex Ovechkin': 8, 'Aliaksei Protas': 21, 'Justin Sourdif': 34,
  'Dylan Strome': 17, 'Tom Wilson': 43, 'John Carlson': 74,
  'Declan Chisholm': 47, 'Jakob Chychrun': 6, 'Martin Fehervary': 42,
  'Dylan McIlrath': 52, 'Matt Roy': 3, 'Rasmus Sandin': 38,
  'Trevor van Riemsdyk': 57, 'Charlie Lindgren': 79, 'Clay Stevenson': 33,
  'Logan Thompson': 48,
};

// Normalize name for jersey lookup: strip accents, dots, hyphens, extra spaces
function normalizeForJersey(name: string): string {
  return name
    .toLowerCase()
...
const _jerseyNorm = new Map<string, number>();
for (const [name, num] of Object.entries(JERSEY_NUMBERS)) {
  _jerseyNorm.set(normalizeForJersey(name), num);
}

function getJerseyNumber(name: string): number {
  return JERSEY_NUMBERS[name] ?? _jerseyNorm.get(normalizeForJersey(name)) ?? 0;
}
...
function c(
  ...
  return {
    ...
    jerseyNumber: getJerseyNumber(name),
...
export const NHL_CONTRACT_DATA: Record<string, PlayerContract[]> = {
  ...
  'BUF': [
    ...
    // Goalies
    c('Ukko-Pekka Luukkonen', 'G', 'BUF', 4_750_000, 4, 4, 2029, 'UFA', 'NHL', null, '1999-03-09'),
  ...
  'DET': [
    ...
    c('Simon Edvinsson', 'D', 'DET', 894_167, 2, 1, 2026, 'RFA', 'NHL', null, '2003-02-05'),
  ...
  'FLA': [
    ...
    c('Brad Marchand', 'RW', 'FLA', 5_250_000, 6, 6, 2031, 'UFA', 'LTIR', null, '1988-05-11'),
    ...
    c('Jonah Gadjovich', 'RW', 'FLA', 775_000, 3, 3, 2028, 'UFA', 'LTIR', null, '1998-10-12'),
    ...
    c('Tomas Nosek', 'LW', 'FLA', 775_000, 1, 1, 2026, 'UFA', 'NHL', null),
    // AHL Forwards
    ...
    c('Dmitry Kulikov', 'D', 'FLA', 1_150_000, 3, 3, 2028, 'UFA', 'NHL', null, '1990-10-29'),
  ...
  'MTL': [
    ...
    c('Alex Newhook', 'LW', 'MTL', 2_900_000, 2, 2, 2027, 'RFA', 'NHL', null, '2001-01-28'),
  ...
  'OTT': [
    ...
    c('David Perron', 'LW', 'DET', 4_000_000, 1, 1, 2026, 'UFA', 'NHL', null, '1988-05-28'),
  ...
  'TBL': [
    // Forwards
    c('Brayden Point', 'C', 'TBL', 9_500_000, 6, 5, 2030, 'UFA', 'NHL', 'NMC', '1996-03-13'),
    ...
    // Defensemen
    c('Victor Hedman', 'D', 'TBL', 8_000_000, 5, 4, 2029, 'UFA', 'LTIR', 'NMC', '1990-12-18'),
    ...
    c('Emil Lilleberg', 'D', 'TBL', 800_000, 2, 2, 2027, 'RFA', 'NHL', null, '2001-02-02'),
    c('Maxwell Crozier', 'D', 'TBL', 775_000, 3, 3, 2028, 'UFA', 'IR', null),
    c('Charle-Edouard D\'Astous', 'D', 'TBL', 775_000, 2, 2, 2027, 'UFA', 'NHL', null),
  ...
  'TOR': [
    ...
    c('Dakota Joshua', 'LW', 'TOR', 3_250_000, 3, 3, 2028, 'UFA', 'NHL', null, '1996-05-15'),
  ...
  'NJD': [
    ...
    c('Luke Hughes', 'D', 'NJD', 9_000_000, 7, 7, 2032, 'UFA', 'NHL', null, '2003-09-09'),
  ...
  'NYR': [
    ...
    c('Adam Edstrom', 'LW', 'NYR', 975_000, 2, 2, 2027, 'RFA', 'NHL', null, '2000-10-12'),
    c('Conor Sheary', 'LW', 'NYR', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1992-06-08'),
    ...
    // Defensemen
    c('Adam Fox', 'D', 'NYR', 9_500_000, 4, 4, 2029, 'UFA', 'NHL', 'NMC', '1998-02-17'),
    ...
    // Goalies
    c('Igor Shesterkin', 'G', 'NYR', 11_500_000, 8, 8, 2033, 'UFA', 'NHL', 'NMC', '1995-12-30'),
  ...
  'PHI': [
    ...
    c('Tyson Foerster', 'LW', 'PHI', 3_750_000, 2, 2, 2027, 'RFA', 'NHL', null, '2002-01-18'),
  ...
  'WSH': [
    ...
    c('Connor McMichael', 'C', 'WSH', 2_100_000, 1, 1, 2026, 'RFA', 'NHL', null, '2001-01-15'),
    ...
    c('Charlie Lindgren', 'G', 'WSH', 3_000_000, 3, 3, 2028, 'UFA', 'NHL', null, '1993-12-18'),
  ...
  'UTA': [
    // --- Forwards ---
    c('JJ Peterka', 'RW', 'UTA', 7_700_000, 5, 5, 2030, 'UFA', 'NHL', 'M-NTC', '2002-01-14'),
    c('Clayton Keller', 'LW', 'UTA', 7_150_000, 3, 3, 2028, 'UFA', 'NHL', 'NTC'),
    c('Dylan Guenther', 'RW', 'UTA', 7_142_857, 8, 8, 2033, 'UFA', 'NHL', 'M-NTC', '2003-04-10'),
    c('Nick Schmaltz', 'C', 'UTA', 5_850_000, 1, 1, 2026, 'UFA', 'NHL', 'M-NTC', '1996-02-23'),
    c('Lawson Crouse', 'LW', 'UTA', 4_300_000, 2, 2, 2027, 'UFA', 'NHL', null, '1997-06-23'),
    c('Jack McBain', 'C', 'UTA', 4_250_000, 5, 5, 2030, 'UFA', 'NHL', null, '2000-01-06'),
    c('Alex Kerfoot', 'RW', 'UTA', 3_000_000, 1, 1, 2026, 'UFA', 'NHL', 'M-NTC'),
    c('Barrett Hayton', 'C', 'UTA', 2_650_000, 1, 1, 2026, 'RFA', 'NHL', null, '2000-06-09'),
    c('Brandon Tanev', 'LW', 'UTA', 2_500_000, 3, 3, 2028, 'UFA', 'NHL', 'M-NTC', '1991-12-31'),
    c('Kevin Stenlund', 'C', 'UTA', 2_000_000, 1, 1, 2026, 'UFA', 'NHL', null, '1996-09-20'),
    c('Liam O\'Brien', 'RW', 'UTA', 1_000_000, 2, 2, 2027, 'UFA', 'NHL', null),
    c('Logan Cooley', 'C', 'UTA', 950_000, 9, 9, 2034, 'UFA', 'NHL', null, '2004-05-04'),
    c('Danil But', 'LW', 'UTA', 950_000, 3, 3, 2028, 'RFA', 'NHL', null),
    c('Michael Carcone', 'RW', 'UTA', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1996-05-19'),
    c('Kailer Yamamoto', 'RW', 'UTA', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1998-09-29'),
    c('Ben McCartney', 'LW', 'UTA', 775_000, 2, 2, 2027, 'RFA', 'NHL', null, '2001-07-13'),
    // --- Defense ---
    c('Mikhail Sergachev', 'D', 'UTA', 8_500_000, 6, 6, 2031, 'UFA', 'NHL', 'M-NTC', '1998-06-25'),
    c('Sean Durzi', 'D', 'UTA', 6_000_000, 3, 3, 2028, 'UFA', 'NHL', 'M-NTC', '1998-10-21'),
    c('John Marino', 'D', 'UTA', 4_400_000, 2, 2, 2027, 'UFA', 'NHL', 'M-NTC', '1997-05-21'),
    c('Olli Maatta', 'D', 'UTA', 3_500_000, 3, 3, 2028, 'UFA', 'NHL', 'M-NTC'),
    c('Nate Schmidt', 'D', 'UTA', 3_500_000, 3, 3, 2028, 'UFA', 'NHL', 'M-NTC', '1991-07-16'),
    c('Ian Cole', 'D', 'UTA', 2_800_000, 1, 1, 2026, 'UFA', 'NHL', null, '1989-02-21'),
    c('Dmitriy Simashev', 'D', 'UTA', 950_000, 3, 3, 2028, 'RFA', 'NHL', null),
    c('Maveric Lamoureux', 'D', 'UTA', 886_667, 2, 2, 2027, 'RFA', 'NHL', null),
    c('Nick DeSimone', 'D', 'UTA', 800_000, 1, 1, 2026, 'UFA', 'NHL', null, '1994-11-21'),
    // --- Goalies ---
    c('Karel Vejmelka', 'G', 'UTA', 4_750_000, 5, 5, 2030, 'UFA', 'NHL', 'M-NTC', '1996-05-25'),
    c('Vitek Vanecek', 'G', 'UTA', 1_500_000, 1, 1, 2026, 'UFA', 'NHL', null, '1996-01-09'),
    c('Anson Thornton', 'G', 'UTA', 795_556, 1, 1, 2026, 'RFA', 'IR', null),
    c('Matt Villalta', 'G', 'UTA', 775_000, 1, 1, 2026, 'UFA', 'NHL', null),
    // --- Non-Roster ---
    c('Tij Iginla', 'C', 'UTA', 1_942_500, 3, 3, 2028, 'RFA', 'AHL', null),
    c('Cole Beaudoin', 'C', 'UTA', 942_500, 3, 3, 2028, 'RFA', 'AHL', null),
    c('Julian Lutz', 'LW', 'UTA', 950_000, 2, 2, 2027, 'RFA', 'AHL', null),
    c('Miko Matikka', 'RW', 'UTA', 950_000, 2, 2, 2027, 'RFA', 'AHL', null),
    c('Owen Allard', 'C', 'UTA', 869_167, 2, 2, 2027, 'RFA', 'AHL', null),
    c('Gabe Smith', 'C', 'UTA', 869_167, 3, 3, 2028, 'RFA', 'AHL', null),
    c('Noel Nordh', 'LW', 'UTA', 870_000, 3, 3, 2028, 'RFA', 'AHL', null),
    c('Michal Kunc', 'LW', 'UTA', 861_000, 1, 1, 2026, 'RFA', 'AHL', null),
    c('Sam Lipkin', 'LW', 'UTA', 851_667, 2, 2, 2027, 'RFA', 'AHL', null),
    c('Cameron Hebig', 'C', 'UTA', 812_500, 2, 2, 2027, 'UFA', 'AHL', null),
    c('Andrew Agozzino', 'C', 'UTA', 775_000, 1, 1, 2026, 'UFA', 'AHL', null),
    c('Kevin Rooney', 'RW', 'UTA', 775_000, 1, 1, 2026, 'UFA', 'AHL', null),
    c('Artem Duda', 'D', 'UTA', 950_000, 2, 2, 2027, 'RFA', 'AHL', null),
    c('Tomas Lavoie', 'D', 'UTA', 872_500, 3, 3, 2028, 'RFA', 'AHL', null),
    c('Maksymilian Szuber', 'D', 'UTA', 859_167, 2, 2, 2026, 'RFA', 'AHL', null),
    c('Terrell Goldsmith', 'D', 'UTA', 838_333, 3, 3, 2028, 'RFA', 'AHL', null),
    c('Montana Onyebuchi', 'D', 'UTA', 775_000, 2, 2, 2027, 'UFA', 'AHL', null),
    c('Scott Perunovich', 'D', 'UTA', 775_000, 1, 1, 2026, 'UFA', 'AHL', null, '1998-08-18'),
    c('Kevin Connauton', 'D', 'UTA', 775_000, 1, 1, 2026, 'UFA', 'AHL', null, '1990-02-23'),
    c('Jaxson Stauber', 'G', 'UTA', 775_000, 2, 2, 2027, 'UFA', 'AHL', null),
  ],
  ...
  'CHI': [
    ...
    c('Wyatt Kaiser', 'D', 'CHI', 1_700_000, 2, 2, 2027, 'RFA', 'NHL', null, '2002-07-31'),
  ...
  'COL': [
    ...
    c('Logan O\'Connor', 'RW', 'COL', 2_500_000, 6, 6, 2031, 'UFA', 'NHL', 'M-NTC'),
  ...
  'DAL': [
    ...
    c('Lian Bichsel', 'D', 'DAL', 918_333, 2, 2, 2027, 'RFA', 'NHL', null, '2004-05-18'),
    // --- Non-Roster Forwards ---
  ...
  'MIN': [
    ...
    c('Jonas Brodin', 'D', 'MIN', 6_000_000, 3, 3, 2028, 'UFA', 'NHL', 'NMC', '1993-07-12'),
  ...
  'STL': [
    ...
    c('Robert Thomas', 'C', 'STL', 8_125_000, 7, 6, 2031, 'UFA', 'NHL', 'NTC', '1999-07-02'),
    ...
    c('Dylan Holloway', 'LW', 'STL', 2_290_457, 2, 1, 2026, 'RFA', 'NHL', null, '2001-09-23'),
  ...
  'WPG': [
    ...
    c('Haydn Fleury', 'D', 'WPG', 950_000, 2, 2, 2027, 'UFA', 'NHL', null, '1996-07-08'),
  ...
  'ANA': [
    ...
    c('Frank Vatrano', 'LW', 'ANA', 4_571_189, 3, 3, 2028, 'UFA', 'NHL', null, '1994-03-14'),
    ...
    c('Leo Carlsson', 'C', 'ANA', 950_000, 1, 1, 2026, 'RFA', 'NHL', null, '2004-12-26'),
  ...
  'CGY': [
    // Forwards
    c('Jonathan Huberdeau', 'LW', 'CGY', 10_500_000, 6, 6, 2031, 'UFA', 'LTIR', 'NMC', '1993-06-04'),
    ...
    c('Blake Coleman', 'RW', 'CGY', 4_900_000, 2, 2, 2027, 'UFA', 'NHL', null, '1991-11-28'),
  ...
  'EDM': [
    // Forwards
    c('Leon Draisaitl', 'C', 'EDM', 14_000_000, 8, 8, 2033, 'UFA', 'LTIR', 'NMC', '1995-10-27'),
  ...
  'LAK': [
    ...
    c('Alex Turcotte', 'C', 'LAK', 775_000, 2, 2, 2027, 'RFA', 'NHL', null, '2001-02-26'),
    ...
    c('Mikey Anderson', 'D', 'LAK', 4_125_000, 6, 6, 2031, 'UFA', 'NHL', null, '1999-05-25'),
  ...
  'SEA': [
    ...
    c('Berkly Catton', 'LW', 'SEA', 942_500, 3, 3, 2028, 'RFA', 'NHL', null, '2006-01-14'),
    ...
    c('Ben Meyers', 'C', 'SEA', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1998-11-15'),
    // Defense
  ...
  'SJS': [
    ...
    c('Ty Dellandrea', 'C', 'SJS', 1_300_000, 1, 1, 2026, 'RFA', 'NHL', null, '2000-07-21'),
  ...
  'VAN': [
    ...
    c('Brock Boeser', 'RW', 'VAN', 7_250_000, 7, 7, 2032, 'UFA', 'NHL', null, '1997-02-25'),
    ...
    c('Marco Rossi', 'C', 'VAN', 5_000_000, 3, 3, 2028, 'RFA', 'NHL', null, '2001-09-23'),
    ...
    c('Zeev Buium', 'D', 'VAN', 966_500, 2, 2, 2027, 'RFA', 'NHL', null, '2005-12-07'),
    ...
    // Goalies
    c('Thatcher Demko', 'G', 'VAN', 5_000_000, 4, 4, 2029, 'UFA', 'LTIR', null, '1995-12-08'),
  ...
  'VGK': [
    ...
    c('Brandon Saad', 'LW', 'VGK', 2_000_000, 1, 1, 2026, 'UFA', 'NHL', null, '1992-10-27'),
    ...
    // Defense
    c('Alex Pietrangelo', 'D', 'VGK', 8_800_000, 2, 2, 2027, 'UFA', 'LTIR', 'NMC'), // Season-ending LTIR
    ...
    c('Brayden McNabb', 'D', 'VGK', 3_650_000, 3, 3, 2028, 'UFA', 'NHL', null, '1991-01-21'),
    ...
    c('Carter Hart', 'G', 'VGK', 2_000_000, 2, 2, 2027, 'UFA', 'NHL', null, '1998-08-13'),
