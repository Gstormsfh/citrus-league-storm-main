...
export const NHL_CONTRACT_DATA: Record<string, PlayerContract[]> = {
  ...
  'BOS': [
    ...
    c('Lukas Reichel', 'C', 'BOS', 50_000, 1, 1, 2026, 'RFA', 'AHL', null), // Buried penalty
  ...
  'BUF': [
    ...
    c('Sam Carrick', 'C', 'BUF', 1_000_000, 2, 2, 2027, 'UFA', 'NHL', null, '1992-02-04'),
    c('Tage Thompson', 'C', 'BUF', 7_142_857, 5, 5, 2030, 'UFA', 'NHL', null, '1997-10-30'),
    c('Tanner Pearson', 'RW', 'BUF', 1_000_000, 1, 1, 2026, 'UFA', 'NHL', null, '1992-08-10'),
    ...
    c('Logan Stanley', 'D', 'BUF', 1_250_000, 1, 1, 2026, 'UFA', 'NHL', null, '1998-05-26'),
    c('Luke Schenn', 'D', 'BUF', 2_750_000, 1, 1, 2026, 'UFA', 'NHL', null, '1989-11-02'),
  ...
  'DET': [
    ...
    c('Justin Faulk', 'D', 'DET', 6_500_000, 3, 2, 2027, 'UFA', 'NHL', 'M-NTC', '1992-03-20'),
  ...
  'FLA': [
    ...
    c('Cole Reinhardt', 'LW', 'FLA', 812_500, 2, 2, 2027, 'UFA', 'NHL', null, '2000-02-01'),
    ...
    c('Vinnie Hinostroza', 'RW', 'FLA', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1994-04-03'),
  ...
  'OTT': [
    ...
    c('Warren Foegele', 'LW', 'OTT', 3_500_000, 2, 2, 2027, 'UFA', 'NHL', null, '1996-04-01'),
  ...
  'TBL': [
    ...
    c('Corey Perry', 'RW', 'TBL', 2_000_000, 1, 1, 2026, 'UFA', 'NHL', null, '1985-05-16'),
  ...
  'CAR': [
    ...
    c('Nicolas Deslauriers', 'LW', 'CAR', 1_750_000, 1, 1, 2026, 'UFA', 'NHL', null, '1991-02-22'),
  ...
  'CBJ': [
    ...
    c('Conor Garland', 'RW', 'CBJ', 4_950_000, 7, 7, 2032, 'UFA', 'NHL', null, '1996-03-11'),
  ...
  'NYI': [
    ...
    c('Brayden Schenn', 'C', 'NYI', 6_500_000, 4, 3, 2028, 'UFA', 'NHL', 'M-NTC', '1991-08-22'),
  ...
  'NYR': [
    ...
    c('Tye Kartye', 'LW', 'NYR', 1_250_000, 2, 2, 2027, 'RFA', 'NHL', null, '2001-04-30'),
  ...
  'PHI': [
    ...
    c('Luke Glendening', 'C', 'PHI', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1989-04-28'),
    ...
    c('David Jiricek', 'D', 'PHI', 918_333, 1, 1, 2026, 'RFA', 'AHL', null),
  ...
  'PIT': [
    ...
    c('Elmer Soderblom', 'LW', 'PIT', 1_125_000, 2, 2, 2027, 'RFA', 'NHL', null, '2001-07-05'),
  ...
  'WSH': [
    ...
    c('David Kampf', 'C', 'WSH', 1_100_000, 1, 1, 2026, 'UFA', 'NHL', null, '1995-01-12'),
    ...
    c('Timothy Liljegren', 'D', 'WSH', 3_000_000, 1, 1, 2026, 'UFA', 'NHL', null, '1999-04-30'),
  ...
  'UTA': [
    ...
    c('MacKenzie Weegar', 'D', 'UTA', 6_250_000, 6, 6, 2031, 'UFA', 'NHL', 'M-NTC', '1994-01-07'),
  ...
  'CHI': [
    ...
    c('Andrew Mangiapane', 'LW', 'CHI', 3_600_000, 2, 2, 2027, 'UFA', 'NHL', null, '1996-04-04'),
  ...
  'COL': [
    ...
    c('Nazem Kadri', 'C', 'COL', 7_000_000, 4, 4, 2029, 'UFA', 'NHL', 'M-NTC', '1990-10-06'),
    c('Nicolas Roy', 'C', 'COL', 3_000_000, 2, 2, 2027, 'UFA', 'NHL', null, '1997-02-05'),
    ...
    c('Brett Kulak', 'D', 'COL', 2_750_000, 1, 1, 2026, 'UFA', 'NHL', null, '1994-01-06'),
    ...
    c('Nick Blankenburg', 'D', 'COL', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1998-05-12'),
  ...
  'DAL': [
    ...
    c('Tyler Myers', 'D', 'DAL', 3_000_000, 2, 2, 2027, 'UFA', 'NHL', null, '1990-02-01'),
  ...
  'MIN': [
    ...
    c('Bobby Brink', 'RW', 'MIN', 1_500_000, 1, 1, 2026, 'RFA', 'NHL', null, '2001-07-08'),
    ...
    c('Michael McCarron', 'C', 'MIN', 900_000, 1, 1, 2026, 'UFA', 'NHL', null, '1995-03-07'),
    c('Nick Foligno', 'C', 'MIN', 4_500_000, 2, 1, 2026, 'UFA', 'NHL', null, '1987-10-31'),
    ...
    c('Robby Fabbri', 'RW', 'MIN', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1996-01-22'),
    ...
    c('Jeff Petry', 'D', 'MIN', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '1987-12-09'),
  ...
  'STL': [
    ...
    c('Jonathan Drouin', 'LW', 'STL', 4_000_000, 2, 2, 2027, 'UFA', 'NHL', null, '1995-03-28'),
    ...
    c('Justin Holl', 'D', 'STL', 3_400_000, 2, 1, 2026, 'UFA', 'AHL', null),
  ...
  'ANA': [
    ...
    c('John Carlson', 'D', 'ANA', 8_000_000, 1, 1, 2026, 'UFA', 'NHL', 'NMC', '1990-01-10'),
  ...
  'CGY': [
    ...
    c('Ryan Strome', 'C', 'CGY', 5_000_000, 2, 2, 2027, 'UFA', 'NHL', null, '1993-07-11'),
    c('Sam Morton', 'C', 'CGY', 775_000, 1, 1, 2026, 'RFA', 'AHL', null),
    c('Samuel Honzek', 'LW', 'CGY', 886_667, 3, 3, 2028, 'RFA', 'LTIR', null, '2004-11-12'),
    c('Victor Olofsson', 'RW', 'CGY', 1_575_000, 1, 1, 2026, 'UFA', 'NHL', null, '1995-07-18'),
  ...
  'EDM': [
    ...
    c('Colton Dach', 'LW', 'EDM', 825_000, 2, 1, 2026, 'RFA', 'NHL', null, '2003-01-04'),
    ...
    c('Jason Dickinson', 'C', 'EDM', 4_250_000, 2, 1, 2026, 'UFA', 'NHL', null, '1995-07-04'),
    ...
    c('Connor Murphy', 'D', 'EDM', 4_400_000, 2, 1, 2026, 'UFA', 'NHL', 'M-NTC', '1993-03-26'),
  ...
  'LAK': [
    ...
    c('Mathieu Joseph', 'RW', 'LAK', 2_950_000, 1, 1, 2026, 'UFA', 'NHL', null, '1997-02-09'),
    ...
    c('Scott Laughton', 'C', 'LAK', 1_500_000, 1, 1, 2026, 'UFA', 'NHL', null, '1994-05-30'),
  ...
  'SEA': [
    ...
    c('Bobby McMann', 'LW', 'SEA', 1_350_000, 1, 1, 2026, 'UFA', 'NHL', null, '1996-06-15'),
  ...
  'VAN': [
    ...
    c('Curtis Douglas', 'LW', 'VAN', 775_000, 1, 1, 2026, 'UFA', 'NHL', null, '2000-03-06'),
  ...
  'VGK': [
    ...
    c('Nic Dowd', 'C', 'VGK', 3_000_000, 2, 2, 2027, 'UFA', 'NHL', null, '1990-05-27'),
