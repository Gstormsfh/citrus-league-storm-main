...
const field =
  'w-full h-12 rounded-xl bg-white/5 border border-white/10 px-4 text-pastel-cream placeholder:text-pressbox-text/60 focus:outline-none focus:ring-2 focus:ring-pastel-orange/40';
const label = 'block text-[13px] text-pressbox-text/70 mb-2';
        ...
        <section className="max-w-[1100px] mx-auto px-6 py-12 md:py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="font-condensed font-extrabold uppercase text-[2.6rem] md:text-[4rem] leading-[0.95] tracking-[-0.01em] text-pressbox-text mb-5">
              Bring your <span className="text-pressbox-orange">league</span>
            </h1>
              ...
              <div className="p-6 md:p-8">
                {status === 'done' ? (
                  <div className="text-center" role="status">
                    <p className="font-condensed font-extrabold uppercase text-[1.4rem] text-pastel-cream mb-2">Got it.</p>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-pastel-cream placeholder:text-pressbox-text/60 focus:outline-none focus:ring-2 focus:ring-pastel-orange/40"
                      ...
                      />
                      <p className="mt-2 text-[12px] text-pressbox-text/60">Paste it from your current settings page, or just describe it. We will confirm anything unclear by email.</p>
                    </div>
                    <div>
