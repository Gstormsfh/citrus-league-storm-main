          ...
          <div className="max-w-[1100px] mx-auto px-6 py-16 md:py-24">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                <Link
                  to="/create-league"
                  className="inline-flex items-center gap-2 bg-pastel-orange text-white text-[14px] font-bold px-6 rounded-md hover:bg-pastel-orange-deep hover:-translate-y-0.5 active:scale-95 transition-all duration-200 shadow-[0_4px_16px_-4px_rgba(255,107,26,0.5)]"
                  style={{ height: '48px' }}
                >
