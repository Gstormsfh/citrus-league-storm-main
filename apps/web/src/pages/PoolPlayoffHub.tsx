        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] xl:grid-cols-[1fr_360px] gap-4 xl:gap-6">
            ...
            <div className="space-y-4">
                                  ...
                                  return (
                                    <div key={p.player_id} className="flex items-center justify-between gap-2 text-xs">
                                      ...
                                      {hasGameData ? (
                                        ...
                                        <span className="text-[10px] text-white/40 italic flex-shrink-0">Not started</span>
                                      )}
                                    </div>
                                  );
                                })}
                            ...
                            {pick && pickedInfo ? (
                              <>
                                ...
                                {isFinal && pick.points_earned != null && (
                                  <span className={cn('text-xs font-bold flex-shrink-0', isCorrect ? 'text-green-600' : 'text-white/40')}>
                                    +{pick.points_earned}
                                  </span>
                                )}
                              </>
                            ) : (
                              <span className="text-[11px] text-white/40 italic flex-1">No pick yet</span>
                            )}
                          </div>
                        );
                      })}
              ...
              <Card className="bg-pastel-surface-tile border-0 ring-1 ring-pastel-sage/30 rounded-2xl">
                <CardHeader className="pb-2">
                  <CardTitle className="text-base flex items-center gap-2">
                                ...
                                >
                                  ...
                                  {isRosterPool && (
                                    <td className="px-3 py-2 text-right">
                                      <Eye className="h-4 w-4 text-white/30 inline" />
                                    </td>
                                  )}
                                </tr>
                              );
              ...
              <Card className="bg-pastel-surface-tile border-0 ring-1 ring-pastel-orange/30 rounded-2xl shadow-[0_16px_40px_-12px_rgba(0,0,0,0.4)]">
                ...
                <CardContent className="space-y-2">
                  ...
                  >
                    ...
                    {copied ? <Check className="h-4 w-4 text-green-600" /> : <Copy className="h-4 w-4 text-white/50" />}
                  </button>
