  ...
  if (success) {
    return (
      ...
      <DarkLayout>
        ...
        <main className="pb-type-phone relative flex items-center justify-center p-4 py-12 min-h-[calc(100vh-68px)] max-lg:min-h-screen max-lg:bg-pressbox-surface max-lg:text-pressbox-text max-lg:px-5 max-lg:pt-[calc(2.5rem+var(--safe-area-inset-top,env(safe-area-inset-top)))]">
