        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-4 mb-10">
              <Link
                to="/create-league"
                className="group inline-flex items-center gap-2 bg-pastel-forest text-pastel-cream text-[15px] font-semibold pl-7 pr-6 h-13 rounded-full hover:bg-pastel-orange-deep hover:-translate-y-0.5 transition-all duration-200 shadow-[0_8px_24px_-8px_rgba(27,48,34,0.4)]"
                style={{ height: '52px' }}
              >
                <span>Play Now</span>
      ...
      <section className="max-w-[1240px] mx-auto px-6 pb-20">
        <div className="bg-white/65 backdrop-blur-md ring-1 ring-pastel-sage/30 rounded-[28px] p-8 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <Link
              to="/draft"
              className="inline-flex items-center gap-2 bg-pastel-forest text-pastel-cream text-[14px] font-semibold pl-6 pr-5 h-11 rounded-full hover:bg-pastel-orange-deep transition-colors"
            >
      ...
      <section className="max-w-[1240px] mx-auto px-6 pb-20">
        <div className="bg-pastel-forest text-pastel-cream rounded-[28px] p-10 md:p-14 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <Link
              to="/create-league"
              className="inline-flex items-center gap-2 bg-pastel-orange text-white text-[15px] font-semibold pl-7 pr-6 h-13 rounded-full hover:bg-white hover:text-pastel-forest transition-colors shadow-[0_8px_24px_-8px_rgba(255,107,26,0.5)]"
              style={{ height: '52px' }}
            >
