...
const Auth = () => {
  ...
  return (
    <DarkLayout>
      ...
      />
      <main className="pb-type-phone relative z-10 flex items-center justify-center px-4 pt-[calc(2.5rem+var(--safe-area-inset-top,env(safe-area-inset-top)))] pb-12 lg:pt-[calc(7rem+var(--safe-area-inset-top,env(safe-area-inset-top)))] lg:pb-20 min-h-[calc(100vh-92px)] max-lg:min-h-screen max-lg:bg-pressbox-surface max-lg:text-pressbox-text max-lg:px-5">
