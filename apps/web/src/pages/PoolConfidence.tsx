    ...
    <DarkLayout>
      ...
      <main className="w-full pt-2 lg:pt-2 lg:pb-8 pb-[calc(5rem+env(safe-area-inset-bottom))]">
        ...
        <div className="flex-1 min-w-0 px-3 sm:px-4 lg:px-8 xl:px-12">
          ...
          {/* Page header — Stormy mascot peek (the strategist) */}
          <div className="relative mb-4 mt-4 px-1 flex items-end justify-between gap-3 flex-wrap">
            ...
            <MascotPeek id="stormy" position="bottom-right" size="sm" className="!relative !inset-auto" />
          </div>
              ...
              {games.length === 0 ? (
                <GlowCard accent="orange" className="max-w-xl mx-auto">
                  <div className="py-16 text-center">
                    <XGModelIcon className="w-12 h-12 mx-auto mb-4 text-white/30" />
