      ...
      <section className="max-w-[1240px] mx-auto px-6 pb-20">
        <div className="bg-pastel-forest text-pastel-cream rounded-[28px] p-10 md:p-14 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <Link
              to="/create-league"
              className="inline-flex items-center gap-2 bg-pastel-orange text-white text-[15px] font-semibold pl-7 pr-6 rounded-full hover:bg-white hover:text-pastel-forest transition-colors shadow-[0_8px_24px_-8px_rgba(255,107,26,0.5)]"
              style={{ height: '52px' }}
            >
