    ...
    <div className="space-y-6">
      ...
      {!selectedTeam && (
        <div className="text-center py-8 bg-pastel-surface-tile rounded-2xl border-2 border-dashed border-citrus-sage/40">
          <PenLine className="w-10 h-10 text-citrus-sage/75 mx-auto mb-3" />
            ...
            <div className="space-y-3">
              ...
              {expiringPlayers.length > 0 && (
                ...
                >
                  ...
                  <Badge className="bg-amber-500/20 text-amber-200 text-[8px] font-varsity border border-amber-400/40 ml-auto">
              ...
              {/* New Signing Form */}
              {showForm && !showResignPicker && (
                <div className="bg-pastel-surface-tile rounded-2xl border-2 border-citrus-sage/30 p-4 space-y-3 animate-in fade-in slide-in-from-top-2 duration-200">
                  <h4 className="font-varsity text-sm text-pastel-cream">
                    {resignTarget ? `Re-sign ${resignTarget.name}` : 'New Free Agent Signing'}
                  </h4>
                  {resignTarget && (
                    <div className="text-[10px] text-white/55 font-display -mt-2">
                  ...
                  {!resignTarget && (
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg border border-citrus-sage/30 bg-pastel-surface-tile text-xs font-display text-pastel-cream placeholder:text-white/50 focus:outline-none focus:border-citrus-sage"
                    />
                  )}
                  ...
                  <div className="grid grid-cols-[4rem_1fr_4rem] sm:grid-cols-3 gap-2">
                    ...
                    <input
                      ...
                      className="px-2 py-2 rounded-lg border border-citrus-sage/30 bg-pastel-surface-tile text-xs font-display text-pastel-cream placeholder:text-white/50 focus:outline-none focus:border-citrus-sage min-w-0"
                    />
                    <input
                      type="text"
                      placeholder="Yrs"
                      ...
                      className="px-1.5 sm:px-2 py-2 rounded-lg border border-citrus-sage/30 bg-pastel-surface-tile text-xs font-display text-pastel-cream placeholder:text-white/50 focus:outline-none focus:border-citrus-sage min-w-0"
                    />
                  </div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-citrus-sage text-pastel-surface text-xs font-display font-bold hover:bg-citrus-sage/90 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                    >
                    ...
                    <button
                      onClick={resetForm}
                      className="px-3 py-2 rounded-lg border border-citrus-sage/30 text-white/65 text-xs font-display hover:bg-citrus-sage/10 transition-colors"
                    >
                      Cancel
                    </button>
                  </div>
              ...
              {/* Re-sign Picker */}
              {showResignPicker && (
                <div className="bg-pastel-surface-tile rounded-2xl border-2 border-citrus-sage/30 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="px-4 py-2.5 bg-citrus-sage/10 border-b border-citrus-sage/20">
                    <span className="text-[10px] text-white/65 uppercase font-display font-bold tracking-wider">
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <Badge className={cn("text-[7px] h-3.5 px-1 font-varsity", p.expiryStatus === 'UFA' ? "bg-red-500/90 text-white" : "bg-amber-400 text-pastel-surface")}>{p.expiryStatus}</Badge>
                            </div>
                          </div>
                          <div className="text-right">
                            <div className="font-varsity text-xs text-pastel-cream">{formatCap(p.capHit)}</div>
                            <div className="text-[8px] text-white/55 font-display">current</div>
                          </div>
                        </button>
                      );
                    })}
                  ...
                  <div className="px-3 py-2 border-t border-citrus-sage/20">
                    <button onClick={resetForm} className="text-xs text-white/55 font-display hover:text-pastel-cream transition-colors">
                      Cancel
                    </button>
                  </div>
                </div>
              ...
              {signings.length > 0 && (
                <button
                  onClick={resetAll}
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-xl border-2 border-red-400/40 bg-red-500/15 text-red-400 text-xs font-display font-bold hover:bg-red-500/20 transition-colors"
                >
        ...
        <div className="lg:col-span-3 space-y-4">
          {teamData && impact && (
            <>
              ...
              <div className="bg-pastel-surface-tile rounded-2xl border-2 border-citrus-sage/30 shadow-varsity overflow-hidden">
                <div className="px-4 md:px-6 py-3 bg-gradient-to-r from-citrus-forest via-citrus-forest/95 to-citrus-forest flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-citrus-sage/85 font-display">Cap Impact Analysis</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="bg-white/5 rounded-xl border border-citrus-sage/20 p-3">
                      <div className="text-[9px] text-white/55 uppercase font-display font-bold tracking-wider mb-2">Current</div>
                      <div className="space-y-1.5">
                        <div className="flex justify-between">
                          <span className="text-[10px] text-white/65 font-display">Cap Hit</span>
                          <span className="font-varsity text-xs text-pastel-cream">{formatCap(impact.currentHit)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[10px] text-white/65 font-display">Cap Space</span>
                          <span className={cn("font-varsity text-xs", impact.currentSpace < 0 ? "text-red-400" : "text-emerald-400")}>{formatCap(impact.currentSpace)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[10px] text-white/65 font-display">Contracts</span>
                    ...
                    <div className={cn(
                      ...
                      signings.length === 0 ? "bg-white/5 border-citrus-sage/20" :
                      impact.isOverCap ? "bg-red-500/15 border-red-400/40" : "bg-emerald-500/15 border-emerald-400/40"
                    )}>
                      <div className="text-[9px] text-white/55 uppercase font-display font-bold tracking-wider mb-2">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="flex justify-between">
                          <span className="text-[10px] text-white/65 font-display">Cap Space</span>
                          <span className={cn("font-varsity text-xs", impact.newSpace < 0 ? "text-red-400" : "text-emerald-400")}>
                            {impact.newSpace < 0 ? '-' : ''}{formatCap(Math.abs(impact.newSpace))}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[10px] text-white/65 font-display">Contracts</span>
                          <span className={cn("font-varsity text-xs", impact.isOverContracts ? "text-red-400" : "text-pastel-cream")}>
                  ...
                  {signings.length > 0 && (
                    <div className={cn(
                      ...
                      impact.netChange > 0 ? "bg-red-500/15 border-red-400/40" : "bg-emerald-500/15 border-emerald-400/40"
                    )}>
                      <span className="text-xs font-display font-bold text-white/70">Net Cap Change</span>
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className={cn("font-varsity text-base", impact.netChange > 0 ? "text-red-400" : "text-emerald-400")}>
                  ...
                  {impact.isOverCap && signings.length > 0 && (
                    <div className="flex items-center gap-2 px-4 py-2.5 mt-3 rounded-xl bg-red-500/15 border-2 border-red-400/40">
                      <AlertTriangle className="w-4 h-4 text-red-400 flex-shrink-0" />
                      <span className="text-xs font-display font-bold text-red-300">
              ...
              {signings.length > 0 && (
                <div className="bg-pastel-surface-tile rounded-2xl border-2 border-citrus-sage/30 shadow-varsity overflow-hidden">
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          i % 2 === 0 ? "bg-pastel-surface" : "bg-white/5"
                        )}
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[9px] text-white/55 font-display">{sig.term}yr</span>
                            {sig.isResign && oldPlayer && (
                              <span className="text-[8px] text-white/50 font-display">
                  ...
                  <div className="px-4 py-3 bg-gradient-to-r from-citrus-sage/15 to-citrus-sage/10 border-t-2 border-citrus-sage/30 flex items-center justify-between">
                    <span className="text-xs font-display font-bold text-white/65 uppercase tracking-wider">
                      Total New Cap
                    </span>
              ...
              {/* Empty State */}
              {signings.length === 0 && (
                <div className="flex flex-col items-center justify-center py-12 bg-pastel-surface rounded-2xl border-2 border-dashed border-citrus-sage/30">
                  <PenLine className="w-8 h-8 text-citrus-sage/60 mb-2" />
                  <p className="text-sm text-white/55 font-display mb-1">No signings yet</p>
          ...
          {!selectedTeam && (
            <div className="flex flex-col items-center justify-center py-20 bg-pastel-surface rounded-2xl border-2 border-dashed border-citrus-sage/30">
              <PenLine className="w-8 h-8 text-citrus-sage/60 mb-2" />
              <p className="text-sm text-white/55 font-display">Select a team to start signing players</p>
            </div>
          )}
        </div>
      </div>
