...
export function PressBoxHome({ inOffseason, className }: PressBoxHomeProps) {
  ...
  return (
    ...
    <div className={cn(PB_TYPE, 'min-h-screen bg-pressbox-surface pt-[var(--safe-area-inset-top,env(safe-area-inset-top))] pb-app-chrome', className)} data-testid="pressbox-home">
      <PressBoxAppHeader
        logoSrc="/favicon.svg"
