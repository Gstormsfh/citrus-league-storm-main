...
describe('dashboardEntryToHockeyPlayer', () => {
  ...
  it('carries the season line the index holds, PIM, SHP and TOI per game included', () => {
    ...
    expect(dashboardEntryToHockeyPlayer(entry(9, { toi_seconds: null })).stats.toi).toBeUndefined();
    expect(dashboardEntryToHockeyPlayer(entry(9, { toi_seconds: 0 })).stats.toi).toBe('0:00');
