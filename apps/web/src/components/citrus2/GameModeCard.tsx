...
export function GameModeCard({
  ...
  const button = (
    <button className="mt-auto w-full inline-flex items-center justify-center gap-1.5 bg-pastel-orange text-[#581E00] px-4 h-10 rounded-md text-[13px] font-bold hover:bg-pastel-orange-deep transition-all duration-200 active:scale-95 group/btn">
