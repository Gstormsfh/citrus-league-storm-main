...
export function OnboardingCard({
  ...
  const button = (
    <button className="mt-auto inline-flex items-center gap-1.5 bg-pastel-orange text-[#581E00] px-5 h-10 rounded-md text-[13px] font-bold hover:bg-pastel-orange-deep transition-all duration-200 active:scale-95 group/btn w-fit">
