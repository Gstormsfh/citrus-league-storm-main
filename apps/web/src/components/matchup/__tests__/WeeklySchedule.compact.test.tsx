// WeeklySchedule `compact` (2026-09-01, audit R4) — the one-row day picker
...
const renderCompact = (selectedDate: string | null, onDayClick = vi.fn()) => {
  ...
  const utils = render(
    <WeeklySchedule compact weekStart={weekStart} weekEnd={weekEnd} onDayClick={onDayClick} selectedDate={selectedDate} hideScores />,
  );
...
describe('WeeklySchedule compact — the day-state lock still holds', () => {
...
describe('WeeklySchedule compact — what changed on purpose', () => {
