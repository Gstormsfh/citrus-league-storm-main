...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#D4E8B8] dark:bg-background pt-20 pb-10 border-t-2 border-citrus-sage/40 dark:border-border relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 border-b-3 border-citrus-sage/20 pb-12 mb-10">
          ...
          <div>
            <h4 className="font-display font-bold text-base uppercase text-citrus-forest dark:text-foreground mb-5 tracking-wide">Product</h4>
            <ul className="space-y-3">
              <li><Link to="/features" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Features</Link></li>
              <li><Link to="/draft-room" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Draft Room</Link></li>
          ...
          <div>
            <h4 className="font-display font-bold text-base uppercase text-citrus-forest dark:text-foreground mb-5 tracking-wide">Resources</h4>
            <ul className="space-y-3">
              <li><Link to="/news" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Player News</Link></li>
              <li><Link to="/standings" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Standings</Link></li>
              <li><Link to="/gm-office/stormy" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Stormy AI</Link></li>
              <li><a href="mailto:CitrusFantasySports@Gmail.com" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Contact Support</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="font-display font-bold text-base uppercase text-citrus-forest dark:text-foreground mb-5 tracking-wide">Legal</h4>
            <ul className="space-y-3">
              <li><Link to="/settings" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Account Settings</Link></li>
              <li><Link to="/privacy" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Privacy Policy</Link></li>
              <li><Link to="/terms" className="text-citrus-forest dark:text-muted-foreground hover:text-citrus-sage dark:hover:text-foreground transition-colors font-sans">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
