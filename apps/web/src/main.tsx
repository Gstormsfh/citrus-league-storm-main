...
if (!rootElement) {
  ...
  document.body.innerHTML = '<div style="padding: 20px; font-family: sans-serif; background: #0F1F15; min-height: 100vh; color: rgba(255,255,255,0.55);"><h1 style="color: #fca5a5;">Error: Root element not found!</h1></div>';
...
try {
  ...
  if (rootElement) {
    rootElement.innerHTML = `
      <div style="padding: 20px; font-family: sans-serif; background: #0F1F15; min-height: 100vh; display: flex; align-items: center; justify-content: center;">
        <div style="max-width: 600px;">
          <h1 style="color: #fca5a5; font-size: 24px; margin-bottom: 16px;">Critical Error</h1>
          <p style="color: rgba(255,255,255,0.55); margin-bottom: 16px;">The application failed to start. Check the console for details.</p>
          <pre style="background: #1A2A20; padding: 16px; border-radius: 4px; overflow: auto; border: 1px solid rgba(255,255,255,0.1); font-size: 12px; color: #FFF8F0;">
