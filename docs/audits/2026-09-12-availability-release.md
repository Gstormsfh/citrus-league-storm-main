...
The same actual replay preserved Test September 27–October 3 Matchup projections 224.2/224.0 and Finalsz September 28–October 4 projections 128.6/108.9, with actual totals zero. Finalsz Free Agents retained J.T. Miller 14.0 points over four games and Shesterkin 13.0 points, 2.7 expected starts over four team games. These are focused examples, not independent full-roster recomputation.
