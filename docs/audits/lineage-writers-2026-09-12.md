...
## Actual matchup points: acquisition → eligible scoring → persisted scores

Additional **R/repository-only** trace,12September. This extension did not query production or measure latency. SQL snapshot bodies below are dated2026-08-13; the later September3 total-score migration supersedes its legacy total-score call. Reconciliation owns live-definition/performance proof. Actual earned points are separate from ROS/daily expected-start forecasts.

| Stage | Executable evidence | Value/eligibility contract |
|---|---|---|
| NHL live refresh | [daemon processing](/Users/gstorms/.codex/worktrees/8265/citrus/data-pipeline/acquisition/data_scraping_service.py:324) fetches/stores raw game and calls process_game_data_citrus at336; [live parser](/Users/gstorms/.codex/worktrees/8265/citrus/data-pipeline/acquisition/scrape_live_nhl_stats.py:45) updates NHL game status/scores, imports official boxscore extractor at65 and persists stats at135. | Boxscore/PBP acquisition updates nhl_games and player_game_stats; authoritative game date is resolved rather than guessed from today's date. External daemon execution remains unverified here. |
| Official player-game writes | [goalie upsert](/Users/gstorms/.codex/worktrees/8265/citrus/data-pipeline/acquisition/scrape_per_game_nhl_stats.py:737), [skater upsert](/Users/gstorms/.codex/worktrees/8265/citrus/data-pipeline/acquisition/scrape_per_game_nhl_stats.py:779). | Conflict key season,game_id,player_id. NHL count columns feed actual points; xG/ROS values are not substitutions for earned goals or saves. |
| Scoring trigger path | [daemon matchup refresh](/Users/gstorms/.codex/worktrees/8265/citrus/data-pipeline/acquisition/data_scraping_service.py:580) invokes [update_active_matchup_scores](/Users/gstorms/.codex/worktrees/8265/citrus/data-pipeline/scoring/calculate_matchup_scores.py:680), which calls update_all_matchup_scores at712. | This executed function delegates to SQL. Other Python arithmetic helpers in the file do not prove this particular daemon call computes points independently. Failures are caught/logged. |
| Eligible player/date/stat arithmetic | [snapshot score_matchup_lines](/Users/gstorms/.codex/worktrees/8265/citrus/supabase/schema/production_snapshot_20260813.sql:9880). | Joins fantasy_daily_rosters active slots to player_game_stats on playerID+roster date, regular nhl_games by gameID, v_player_game_stat_long by gameID/playerID, and league rules. Filters matchup,team,inclusive week dates. Sums stat value×multiplier, rounds3decimals per player/date. Bench/current ownership alone does not grant historical points. |
| Rules source | [snapshot get_effective_scoring_rules](/Users/gstorms/.codex/worktrees/8265/citrus/supabase/schema/production_snapshot_20260813.sql:5179). | stat_catalog + league_scoring_rules league override → default-league rule → catalog default. This is a rules-table contract, distinct from the frontend's fixed JSON formula shown in the consumer extension. |
| Team/day and week totals | [snapshot calculate_daily_matchup_scores_v2](/Users/gstorms/.codex/worktrees/8265/citrus/supabase/schema/production_snapshot_20260813.sql:1438); [September3 total-score change](/Users/gstorms/.codex/worktrees/8265/citrus/supabase/migrations/20260903210000_matchup_scoreboard_uses_v2_scoring_rules.sql:189). | v2 aggregates score_matchup_lines by date; latest checked-in calculate_matchup_total_score sums v2. [Snapshot update_all_matchup_scores](/Users/gstorms/.codex/worktrees/8265/citrus/supabase/schema/production_snapshot_20260813.sql:11640) calls total-score function for teams and updates matchups.team1_score/team2_score at11695. Verify live definitions before treating this as deployed proof. |
| Persistent player audit lines | [snapshot persist_matchup_lines](/Users/gstorms/.codex/worktrees/8265/citrus/supabase/schema/production_snapshot_20260813.sql:7216); [server invocation](/Users/gstorms/.codex/worktrees/8265/citrus/server/src/services/MatchupService.ts:1366). | Delete/rewrite one matchup's fantasy_matchup_lines with per-player total_points and per-stat value/multiplier/points. Same regular-game/frozen-active eligibility and rules relation. This is a purposeful audit representation, not redundant because totals are also on matchups. |
| API-triggered scoring | [MatchupService.calculateDailyMatchupScores](/Users/gstorms/.codex/worktrees/8265/citrus/server/src/services/MatchupService.ts:1281) loads week/team/league, backfills missing daily rosters, calls v2 for both teams at1328 and persists audit lines. [league recompute](/Users/gstorms/.codex/worktrees/8265/citrus/server/src/services/MatchupService.ts:775) calls update_all_matchup_scores. | A daily-score request can execute scoring/backfill; it is not just a cached row read. A persist_matchup_lines failure logs but does not fail returned team scores, so successful response does not prove fresh line items. |

### Timing: configuration versus measurements

- Daemon live loop sets30seconds at [1015](/Users/gstorms/.codex/worktrees/8265/citrus/data-pipeline/acquisition/data_scraping_service.py:1015), then sleeps after processing. Final-game cache uses7200seconds at [264](/Users/gstorms/.codex/worktrees/8265/citrus/data-pipeline/acquisition/data_scraping_service.py:264); an older-final branch skips refetch. These are code settings, not observed arrival-to-score delays, and correction timing is a separate path.
- UI's comment claiming scraper90seconds at Matchup.tsx5306 conflicts with the checked-in daemon30second branch. Neither comment supplies deployment evidence. Do not combine them into a claimed measured SLA.
- To measure the actual chain, correlate one game's NHL retrieval timestamp, player_game_stats write/update, score RPC start/end, matchups and line-item persistence, browser request/cache hit, state update and rendered points. Record p50/p95 and correction cases separately. Owner runtime performance investigation is required; no network or SQL benchmark was performed by this extension.
- Refresh overlap proven by callsites: daemon can request update_all_matchup_scores, and visible Matchup page can request the same league recompute every polling cycle. The two entrypoints exist; simultaneous execution/contention is not established without logs.
