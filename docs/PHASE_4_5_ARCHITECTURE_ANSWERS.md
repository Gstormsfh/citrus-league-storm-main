...
2. **Co-manager schema migration** — see [`docs/adr/ADR-003-co-manager-authorization-model.md`](./adr/ADR-003-co-manager-authorization-model.md). Drafted 2026-04-30; pending Zach review.
