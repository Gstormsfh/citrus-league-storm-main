...
**Latest consolidated status:** [Release candidate 1.0 (12)](RELEASE_CANDIDATE_1.0_12.md). The entries below preserve earlier test history; use the consolidated status for current deployment and device state.
