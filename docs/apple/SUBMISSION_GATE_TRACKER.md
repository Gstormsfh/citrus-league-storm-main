...
**Latest consolidated status:** [Release candidate 1.0 (13)](RELEASE_CANDIDATE_1.0_13.md). The entries below preserve earlier test history; use the consolidated status for current deployment and device state.
