...
export const LEAGUE_COLUMNS = 'id, name, commissioner_id, draft_status, join_code, roster_size, draft_rounds, league_size, settings, scoring_settings, scheduled_draft_time, created_at, updated_at';
