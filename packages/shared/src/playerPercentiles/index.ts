...
/**
 * How a cohort is NAMED in prose. Canadian spelling, per STYLEGUIDE.
 *
 * It lives beside the cohort function rather than in the card that first
 * needed it, because the writeup engine now names a cohort too and both
 * sides of the wire have to say the same word. `playerAdvancedMetrics.ts`
 * re-exports this under the name it has always exported.
 */
