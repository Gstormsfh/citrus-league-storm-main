-- Update get_daily_projections RPC to include Monte Carlo uncertainty columns
-- These fields power the "likely range" display and confidence bars in the UI

-- ============================================================================
-- DROP existing functions (both DATE and TEXT overloads)
-- ============================================================================
...
RETURNS TABLE (
    ...
    projection_mean NUMERIC,
    projection_std_dev NUMERIC,
    projection_ci_lower NUMERIC,
    projection_ci_upper NUMERIC,
    projection_ci_50_lower NUMERIC,
    projection_ci_50_upper NUMERIC,
...
'Projection lookup with Monte Carlo uncertainty. Returns point estimates + confidence intervals, likely ranges, and confidence labels for UI display.';
