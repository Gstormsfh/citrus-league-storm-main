...
- **R² Score:** 0.8065 (80.65%)
- **Correlation (Pearson r):** 0.9040
- **MAE (Mean Absolute Error):** 1.404 goals/player
- **RMSE (Root Mean Squared Error):** 2.047 goals/player
- **Players Analyzed:** 816
- **Total xG:** 3311.12
- **Total Goals:** 3,313
- **Calibration Ratio:** 1.00x
- **Mean xG/Player:** 4.058
- **Mean Goals/Player:** 4.060
- **Status:** ✅ EXCELLENT

### 2.2 Game-Level Performance
- **R² Score:** 0.0480 (4.80%)
- **Correlation (Pearson r):** 0.2925
- **MAE (Mean Absolute Error):** 1.83 goals/game
- **RMSE (Root Mean Squared Error):** 2.32 goals/game
- **Games Analyzed:** 533
- **Avg xG/Game:** 6.21
- **Avg Goals/Game:** 6.22
- **Median xG/Game:** 6.18
