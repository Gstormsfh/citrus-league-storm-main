...
\echo 'The residual 12 sync-staleness fails are KI-040 by design.'
\echo ''
\echo 'Ladder step (6): TOMORROW morning, run:'
...
\echo 'Expect: most recent row (04:00 UTC 2026-08-06) status = succeeded.'
\echo '        The 163rd run + first scheduled success since 2026-02-25.'
\echo '=========================================='
