...
VERSION = 'citrus-timing-conditional-calibration-v1'
...
def _settings():
    if SETTINGS != dense.SETTINGS or TIMING_RIDGE != 100.:
        raise ValueError('Frozen conditional settings and timing ridge100 required')
