// Infrastructure v4: v3 fixtures plus v2 precise PostgreSQL permission-denial checks.
...
const sourcePins = {};
for (const name of ['scripts/proof/run_local_model_publication_v4.mjs', 'scripts/local_model_publication_e2e_v2.py', 'scripts/proof/local_access_denial.py', 'scripts/proof/run_local_model_publication_v3.mjs', 'scripts/proof/local_port_contract.mjs', 'scripts/proof/run_local_model_publication_v2.mjs', 'scripts/proof/local_tmpfs_contract.mjs', 'scripts/proof/run_local_model_publication.mjs'])
...
assert.equal(sourcePins['scripts/proof/run_local_model_publication_v3.mjs'], 'f426a6938ea80e569319b1f8edb8e2adbda026ee9fe68c9157e585dcbf151d26');
...
try {
  ...
  worker = spawn(python, ['scripts/local_model_publication_e2e_v2.py', '--base-url', base,
  ...
  result = { status: health.status, owner, infrastructure_version: 4, source_sha256: sourcePins, publishable: false, production_changed: false };
} catch (error) {
