...
## Effective-current runtime edition — 2026-09-12

Imported exact runtime `a2b5d0572707cee400bb4162474600b7ce3e8e689a1b9064e63d67610c744879` / run `099b720a-0880-42ab-91ed-5a4a84db3599`, parent source `1fb82cffbb61e3e9467d3066b61f590b7920ae1fb6ce32abdae0f786d8096e27`. PostgreSQL preimage SHA256 and parsed payload equality are both required; Python reserialization does not stand in for PostgreSQL revision validation. Rates multiply `remaining.used` once; source full-season exposure is retained separately. As-of 2026-09-12, refreshed 10:02:13.183476 UTC. Remaining and full schedules both have 84 team games in this preseason snapshot, but refreshed MODEL rates differ.

Current PDF and XLSX filenames use `Citrus-Effective-Current-a2b5d0572707-10ea21e260b7-DRAFT`; prior source editions are untouched. Local preview8765 follows this runtime; editor8766 retains reviewed source plus separate runtime context. Full snapshot identity, all1325players,5052category/countpairs,674ROS and56616daily materialized rows were compared using owner export evidence. Default and Test supported totals match. Finalsz complete skater totals are unavailable because enabled plus/minus is absent; supported subtotals are not complete scores. The adapter retains optional signed plus/minus and the existing shared scorer patch from70a371f0 handles it when supplied. No additional scorer or production write was introduced.

PDF full validation and rendered visual QA passed189pages. Workbook formula/cached-value QA checks all1325players,32teams,706slots and5335notes. Unsupported workbook scoring keys are rejected. Current artifact hashes, remaining-horizon metadata and detailed receipts are in local `output/canonical-review/LATEST-REVIEW.json`; private signed-in app acceptance and a scheduled refresh observation remain separate pending work.


## Published plus/minus runtime — 2026-09-12

Current runtime858d8a9c/runb0f2b223 was actually published at10:55:47.173443UTC, parenta2b/source1fb. Owner exact PostgreSQL text/preimage and actual postpublication ROS/daily/settings exports drive the new artifacts. Inherited refresh10:02:13 is labelled separately. Component model policies and original source exposure are retained; original source editor remains1fb and exposes858 as derived context.

Default and actual Finalsz editions each contain189PDFpages and32workbookteams. Default674available, Finalsz673/TijonlyPMmissing; all1325profiles and5640presentcategorypairs, exactDecimal baseline fields/exposure and savedweights checked.29existing/focusedtests passed. Fullformula/cachedscores, zero/negative/missing, provenance,706slots/5335notes and visuals passed. Currentpreview/editor identities verified. LATEST points to858;1fb/a2b files and their hash receipts remain intact. Optional activation/component metadata changes do not alter nativeappinputs; unsignedBuild19 at823f remains the validated candidate, without distribution.
