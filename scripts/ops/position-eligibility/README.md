...
The propagation patch reads existing primary plus secondary evidence consistently. It does not infer role changes, grant new positions, modify forecasts, or deploy an app. The primary-correction migration and candidate SQL below are reviewable, **not applied**.
...
| Mats Zuccarello (8475692) | C / RW, 59 | [Current NHLPA profile: RW](https://www.nhlpa.com/player/701/mats-zuccarello/) | Reviewed C→RW primary candidate. One fantasy owner, already saved at RW; no future daily rows. |
| Jaden Schwartz (8475768) | C / LW, 50 | [Current NHLPA profile: LW](https://www.nhlpa.com/player/742/jaden-schwartz/) | Reviewed C→LW primary candidate. Unowned; no saved/future active rows. |
...
No live draft pick, roster transaction, threshold change, primary correction or secondary grant was executed. Autopick preference policy remains owned by PR486; it is not converted into a hard eligibility constraint.
