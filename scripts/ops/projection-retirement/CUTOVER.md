...
Use the [manual-baseline receipt](../../../docs/audits/2026-09-12-manual-baseline-release.md) for publication and exports, and the [repaired Matchup release receipt](../../../docs/audits/2026-09-12-matchup-week-navigation.md#production-release) for latest serving identity and authenticated navigation acceptance. The [scoped exception receipt](../../../docs/audits/2026-09-12-scoped-draft-release-exception.md) preserves the earlier authorized single-run exception and partial acceptance; the final repair shipped through the normal guard without an exception. The [earlier availability release](../../../docs/audits/2026-09-12-availability-release.md) remains historical evidence. Do not copy changing identities into other “current” maps. Publication identity and model-refresh time are separate. A metadata-only publication preserves numerical values and the inherited refresh time; a later scheduled model refresh may retain the same source.
