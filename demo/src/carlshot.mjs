...
await fig.screenshot({path:shot('cs_empty.png')});
...
await p.waitForTimeout(400); await fig.screenshot({path:shot('cs_half.png')});
...
await p.waitForTimeout(700); await fig.screenshot({path:shot('cs_final.png')});
